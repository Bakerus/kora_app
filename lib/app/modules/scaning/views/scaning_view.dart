              ...
              crossAxisAlignment: CrossAxisAlignment.start,
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Text("Scan code to add new account", style: AppTheme.ligthTheme.textTheme.subtitle2),
                        ],),
                      ...
                      Center(
                        child: Column(
                          children: [
                            ...
                            ElevatedButton(onPressed: (){Get.put(ScaningController().scanQR());} ,child: Text("Scan", style: Get.theme.textTheme.button,)),
                          ],),
                      ),
